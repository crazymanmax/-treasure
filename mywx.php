                 ...
                 switch($keyword){
                    ...
                    case '刮奖':
                 	...
                 	case '测试':
                            ...
                            $msgType = "text";
		                	$contentStr = "<a href="."https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx58f393b77aeb9cf1&redirect_uri=".urlencode('http://39.108.1.202/weixin/bb.php')."&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect".">测试</a>";
		                	$resultStr = sprintf($textTpl, $fromUsername, $toUsername, $time, $msgType, $contentStr);
